...
func (x *AddToEventRequest) Reset() {
	*x = AddToEventRequest{}
...
func (x *AddToEventRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddToEventRequest) ProtoMessage() {}

func (x *AddToEventRequest) ProtoReflect() protoreflect.Message {
	mi := &file_adder_proto_msgTypes[0]
...
// Deprecated: Use AddToEventRequest.ProtoReflect.Descriptor instead.
func (*AddToEventRequest) Descriptor() ([]byte, []int) {
	return file_adder_proto_rawDescGZIP(), []int{0}
}

func (x *AddToEventRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AddToEventRequest) GetEventId() int64 {
	if x != nil {
		return x.EventId
	}
	return 0
...
type AddToEventResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AddToEventResponse) Reset() {
	*x = AddToEventResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *AddToEventResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddToEventResponse) ProtoMessage() {}

func (x *AddToEventResponse) ProtoReflect() protoreflect.Message {
	mi := &file_adder_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddToEventResponse.ProtoReflect.Descriptor instead.
func (*AddToEventResponse) Descriptor() ([]byte, []int) {
	return file_adder_proto_rawDescGZIP(), []int{1}
}

func (x *AddToEventResponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *AddToEventResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_adder_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x45, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x54, 0x6f, 0x45, 0x76, 0x65,
	...
	0x28, 0x03, 0x52, 0x07, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x42, 0x0a, 0x12, 0x41,
	0x64, 0x64, 0x54, 0x6f, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x53, 0x0a, 0x0c, 0x41, 0x64, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x43, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x54, 0x6f, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x18, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x64, 0x64, 0x54, 0x6f, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x41, 0x64, 0x64, 0x54, 0x6f, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
var file_adder_proto_goTypes = []interface{}{
	(*AddToEventRequest)(nil),  // 0: proto.AddToEventRequest
	(*AddToEventResponse)(nil), // 1: proto.AddToEventResponse
}
var file_adder_proto_depIdxs = []int32{
	0, // 0: proto.AdderService.AddToEvent:input_type -> proto.AddToEventRequest
	1, // 1: proto.AdderService.AddToEvent:output_type -> proto.AddToEventResponse
...
func file_adder_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_adder_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AddToEventRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_adder_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AddToEventResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
