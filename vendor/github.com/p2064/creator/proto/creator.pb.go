...
func (x *CreateEventRequest) GetMaxPlayers() int64 {
	if x != nil {
		return x.MaxPlayers
	}
	return 0
...
func (x *CreateEventResponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
var file_creator_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5e, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0x53, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x32, 0x58, 0x0a, 0x0e, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x46, 0x0a,
...
var file_creator_proto_depIdxs = []int32{
	0, // 0: proto.CreatorService.CreateEvent:input_type -> proto.CreateEventRequest
	1, // 1: proto.CreatorService.CreateEvent:output_type -> proto.CreateEventResponse
